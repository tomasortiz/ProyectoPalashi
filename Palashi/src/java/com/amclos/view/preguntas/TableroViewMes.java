 ...
 * @author Ultimate
 */
@ManagedBean(name = "TableroViewMes")
@ViewScoped
public class TableroViewMes {
...
//and u.institucioncodigo.codigo=i.codigo and u.codigo='SISLOS'  and p.estado in ('AC001') and p.tipoSituacion.codigo in ('TIS001')
  ...
  //  private ParametroManager param;
    ...
    {
        //preguntas
      preguntasAC001 = pm.listaPreguntasMes(usuario,"TIS001");    
        numeroPreguntasTotalAC001=String.valueOf(preguntasAC001.size());
        
        preguntasAC002=pm.listaPreguntasMes(usuario,"TIS002");    
    ...
    public void guardarRespuesta() {
        ...
        System.out.println("vamo a guardar las respuesta");
